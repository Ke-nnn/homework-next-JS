  ...
  <section className="w-full">
    <div className="w-full h-130 bg-[url('https://images.unsplash.com/photo-1449844908441-8829872d2607?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw2fHxob21lfGVufDB8MHx8fDE3MTA0MDE1NDZ8MA&ixlib=rb-4.0.3&q=80&w=1080')] bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center ">
      ...
      <div className="w-full mx-auto">
        <form>
          <div className="xl:w-1/2 lg:w-[60%] sm:w-[70%] w-[90%] mx-auto flex gap-2 md:mt-6 mt-4">
            <input
              type="text"
            ...
            <button
              type="submit"
              className="px-2.5 bg-blue-500 text-lg text-white rounded-md font-semibold"
            >
              Search
            </button>
          </div>
